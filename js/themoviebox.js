var rule = {
    ...
    homeUrl: '/',
    url: '/web/fyclass?page=fypage',
    detailUrl: '/web/detail/fyid',
    searchUrl: 'https://h5-api.aoneroom.com/wefeed-h5api-bff/subject/search',
    searchable: 1,
    quickSearch: 1,
    filterable: 1,
    play_parse: true,
    ...
    class_name: 'Home&Movie&TV Show',
    class_url: 'home&film&tv-series',
    filter: {
        film: [
    ...
    一级: `js:
        function mbVod(it) { return {vod_id: it.detailPath || it.subjectId || '', vod_name: it.title || '', vod_pic: it.cover && it.cover.url || '', vod_remarks: it.releaseDate || it.imdbRatingValue || ''}; }
        var page = parseInt(MY_PAGE || 1), cate = String(MY_CATE || 'film'), channel = cate === 'tv-series' ? '2' : '1', fl = typeof MY_FL === 'object' ? MY_FL : {}, body = {page: page, perPage: 28, channelId: channel};
